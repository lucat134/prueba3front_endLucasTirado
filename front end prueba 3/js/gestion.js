...
function completarEtiqueta(element,index,arr) {
  ...
  document.getElementById('lbl_eliminar').innerHTML ="¿Desea eliminar este tipo de gestión? <b>"+ nombre_gestion +"</b>";
}
function completarFormulario(element,index,arr) {
  var nombre_gestion = element.nombre_gestion;
  document.getElementById('txt_nombre_gestion').value = nombre_gestion;

}
function actualizarGestion(){
  var nombre_gestion = document.getElementById("txt_nombre_gestion").value;
